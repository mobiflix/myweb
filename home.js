...
// ============================================================
// PLAY NOW  ✅ BUKAS SA player.html (KAPAREHONG TAB)
// ============================================================
...
function playNow() {
  ...
  console.log('[MobiFlix Player] Opening player.html in same tab');

  // ✅ BUKAS SA KAPAREHONG TAB — player.html
  window.location.href = `player.html?id=${currentItem.id}&type=${type}&title=${title}`;
}
