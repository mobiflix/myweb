...
function closeTrailer() {
  // Wala nang modal — para lang hindi mag-error kung may tumawag
  document.body.style.overflow = '';
}
...
async function showDetails(item) {
  ...
  // ⚠️ WALANG history.pushState DITO — para hindi dumami ang back entries
...
function openViewAll(key) {
  ...
  // ✅ I-HIGHLIGHT ANG TAMANG BOTTOM NAV ITEM
  if (key === 'movies') {
    setActiveNav('movies');
  } else if (key === 'tv') {
    setActiveNav('series');
