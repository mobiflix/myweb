...
// ✅ EMBED SITE BASE URLs
const MOVIE_EMBED_BASE = 'https://cinejoy.pk/watch/movie/';
const TV_EMBED_BASE = 'https://cinejoy.pk/watch/tv/';
...
// ============================================================
// ✅ AUTO-REFRESH HELPER — para sa pagbabalik sa homepage
// ============================================================
...
// ============================================================
// PLAY NOW  ✅ DIRETSO SA EMBED SITE SA BAGONG TAB
// ============================================================
...
function playNow() {
  ...
  let embedURL;
  if (isMovie) {
    embedURL = MOVIE_EMBED_BASE + currentItem.id;
  } else {
    embedURL = TV_EMBED_BASE + currentItem.id;
  }

  console.log('[MobiFlix Player] Opening embed in new tab:', embedURL);

  // ✅ DIRETSO SA EMBED SITE SA BAGONG TAB
...
function goHome() {
  ...
  // ✅ AUTO-REFRESH TUWING BABALIK SA HOMEPAGE
  triggerHomeRefresh();
}
