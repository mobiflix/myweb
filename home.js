...
// ============================================================
// KOREAN SERIES FILTER (FIXED — may rating filter na)
// ============================================================
...
// Korean series na may minimum 5 stars
...
// FIXED: Korean Series — may vote_average.gte=5 na
...
// ============================================================
// SEARCH (FIXED — may rating filter sa Korean series)
// ============================================================
...
async function searchTMDB() {
  ...
  searchTimeout = setTimeout(async () => {
    try {
      ...
      // Korean series — may rating filter (5+)
...
// ============================================================
// VIEW ALL PAGE (FIXED — Korean Series may rating filter)
// ============================================================
