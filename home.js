...
// ===== STREAMING PROVIDERS (may For Kids na) =====
const STREAMING_PROVIDERS = [
  { name: 'Netflix', id: 8, type: 'provider', color: '#e50914' },
  { name: 'Netflix Kids', id: 175, type: 'provider', color: '#e50914' },
  { name: 'Disney+', id: 337, type: 'provider', color: '#113ccf' },
  { name: 'Disney+ Kids', id: 390, type: 'provider', color: '#113ccf' },
...
const PROVIDER_LOGOS = {
  ...
  'Netflix Kids': 'https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg',
  'Disney+': 'https://upload.wikimedia.org/wikipedia/commons/3/3e/Disney%2B_logo.svg',
  'Disney+ Kids': 'https://upload.wikimedia.org/wikipedia/commons/3/3e/Disney%2B_logo.svg',
...
async function fetchKidsMovies(page, sortBy) {
  const today = new Date().toISOString().split('T')[0];
  const sort = sortBy || 'primary_release_date.desc';
...
// ============================================================
// ADULT PAGE (Vivamax) - nasa Profile
// ============================================================
...
function openKidsPage() { openViewAll('kids'); }
  ...
  try {
    ...
    if (hasFilters) {
      ...
      if (key === 'movies') {
        ...
        data = await fetchKidsMovies(viewAllState.page, 'primary_release_date.desc');
      } else if (key === 'tv') {
