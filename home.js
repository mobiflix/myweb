...
function closeLayerByType(type, data) {
  switch (type) {
    case 'modal':
      ...
      break;
    case 'player':
      // Ang popstate ang humawak ng pagsasara ng player
      break;
    case 'view-all':
      closeAllPagesOnly();
      setActiveNav('home');
...
window.addEventListener('popstate', function(e) {
  // PRIORITY 1: Kung bukas ang player modal, isara ito
  ...
  // PRIORITY 2: Kung may ibang bukas na layer (modal o page), isara ito
  ...
  // PRIORITY 3: Nasa homepage na — tanungin kung gusto umexit
...
// Ito ang TUNAY na pagsasara ng player (tinatawag lang ng popstate)
function closePlayerModal() {
  ...
  document.body.style.overflow = '';
  // HUWAG mag-pop ng layerStack dito — ang popstate ang may hawak
}
