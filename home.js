...
// FIXED: Korean Series — walang vote_count.gte na masyadong mataas
...
// FIXED: Vivamax — walang filterReleased, latest agad
...
// ============================================================
// SEARCH (FIXED — adult content kapag family mode OFF)
// ============================================================
...
async function searchTMDB() {
  ...
  searchTimeout = setTimeout(async () => {
    try {
      ...
      // Kapag Family Mode OFF — isama ang adult
      ...
      // Family Mode ON — filter adult content
      if (familyMode) {
      ...
      // FIXED: Hindi na masyadong strict — tanggalin ang rating filter sa search
      // para makita ang lahat ng results (adult man o hindi)
...
// ============================================================
// VIEW ALL PAGE (FIXED — Korean Series)
// ============================================================
...
async function loadViewAllBatch() {
  ...
  try {
    ...
    // FIXED: Korean Series — gamitin ang discover/tv direkta
    if (key === 'kdrama') {
      const today = new Date().toISOString().split('T')[0];
...
// ============================================================
// INIT (FIXED — Vivamax always updated, family mode)
// ============================================================
...
async function init() {
  try {
    ...
    // Vivamax — always fetch latest, hide lang kapag Family Mode ON
