...
// Idinagdag ang 16 (Animation) at 10762 (Kids) para ma-exclude
const KOREAN_EXCLUDE_GENRES = [10764, 10767, 10763, 10766, 16, 10762];

// ===== BANNED GENRES (game show, reality, variety, talk, soap, music, documentary, news, politics, animation, kids) =====
const BANNED_GENRES = [10764, 10767, 10763, 10766, 10402, 99, 10768, 16, 10762];
