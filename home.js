...
async function showDetails(item) {
  ...
  // I-save ang last item para maibalik kapag bumalik galing player
  try {
...
async function init() {
  try {
    ...
    // I-check kung may last item (galing player) — ibalik ang details modal
    ...
    // Kung may last item, i-open ang details modal pagkatapos ng init
